...
const MarkerModule = {
  ...
  async init() {
    ...
    try {
      ...
      Utils.error('Ошибка при инициализации модуля маркера:', error);
      return false;
    }
  },
  ...
  async toggleEnabled(enabled) {
    ...
    try {
      ...
      Utils.error('Ошибка при сохранении состояния маркера:', error);
    }
  },
  ...
  async updateMarkers(markers) {
    ...
    try {
      ...
      Utils.error('Ошибка при сохранении маркеров:', error);
    }
  },
  ...
  highlightAll() {
    ...
    try {
      ...
      Utils.error('Ошибка при выделении текста:', error);
    } finally {
  ...
  highlightText(text, color, exactMatch = false) {
    ...
    try {
      ...
      Utils.error(`Ошибка при выделении текста "${text}":`, error);
    }
  },
  ...
  removeAllHighlights() {
    this.highlightedElements.forEach(element => {
      try {
        ...
        Utils.error('Ошибка при удалении выделения:', error);
      }
    });
