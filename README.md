...
1. **Скачайте** последнюю версию расширения со страницы [Releases](https://github.com/LordArrin/BetterChatterBox/releases).
...
❗ Скачивание через браузер может быть ограничено самим браузером. Решение - нажать правой кнопкой мыши по релизному файлу, затем "Сохранить ссылку как...".

  <img width="360" alt="sample" src="https://github.com/user-attachments/assets/0e13401d-150c-4642-8a7c-7ff719d6619f">
...
- 🛠 **Ведущий разработчик и дизайнер**: [@NN_LordArrin](https://t.me/NN_LordArrin)
