...
## Новое в версии 2.1.6.3
- ✨ **Модуль Сканирование — Расчёт верный** - автоматический поиск и анализ блоков "Финальный расчёт" на странице прайсинга и вывод значений в буфер обмена.

## Функциональность
- **Сканирование**: 
  - Тестирование - работает. Определяет какое тестирование прошёл курьер и на какую оценку
  - Расчёт верный - автоматический поиск и анализ блоков "Финальный расчёт" на странице прайсинга и вывод значений в буфер обмена.
...
- **Поиск**: Быстрый поиск по системе таких данных, как: страна, профессия, тарифы, пройденное тестирование, теги
  ...
  - Вывод текста уведомлений с найденными тегами и профессией во внутренний комментарий (можно индивидуально настроить)
  - Автопоиск пресетов при загрузке тикета
  - Автопоиск тестирования при загрузке тикета
  - Автопоиск последних заказов при загрузке тикета
  - Модуль работы с тикетами - улучшенная работа с тикетами и валидация ID
